...
#endif
void core::rend::VertexAttributes::add(int size,int stride,int offset)
{
...
void core::rend::VertexAttributes::add(int size, size_t typeSize, int offset)
{
...
void core::rend::VertexAttributes::vertexDivisor(int index, int divisor)
{
