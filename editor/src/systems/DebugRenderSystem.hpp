...
namespace hexen::editor::systems
{
    ...
    */
	...
	public:
		...
		/**
 		* @brief Constructs a new DebugRenderSystem object.
 		*
 		* This explicit constructor initializes a DebugRenderSystem with a specified amount of storage for vectors.
 		* This is primarily used for pre-allocating space for the vector to optimize memory usage.
 		*
 		* @param sizeOfVectors The initial size allocated for vectors.
 		*/
